      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl font-mono text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ...
            This year, we have included various new types of CTF challenges, expanding the competition with innovative categories and advanced problem-solving experiences for all participants.
          </p>
        </div>
